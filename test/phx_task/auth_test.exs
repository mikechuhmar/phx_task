defmodule PhxTask.AuthTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{login: "some login", name: "some name", password_hash: "some password_hash"}
    @update_attrs %{login: "some updated login", name: "some updated name", password_hash: "some updated password_hash"}
